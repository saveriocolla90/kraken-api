...
#ifndef __krapi__websocket_hpp
#define __krapi__websocket_hpp
...
namespace krapi
{
    ...
    namespace ws
    {
        ...
        struct websockets final
        {
            ...
            websockets(
                boost::asio::io_context &ioctx, std::string host, std::string port, on_message_received_cb msg_cb = {}, on_network_stat_cb stat_cb = {}, std::size_t stat_interval = 1 // in seconds
            );
            ~websockets();
