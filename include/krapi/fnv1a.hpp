...
#ifndef __krapi__fnv1a_hpp
#define __krapi__fnv1a_hpp
...
namespace krapi
{
    ...
    template <
        typename ConstCharPtr, typename = typename std::enable_if<
                                   std::is_same<ConstCharPtr, const char *>::value>::type>
